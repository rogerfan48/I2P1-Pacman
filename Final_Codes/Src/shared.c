...
ALLEGRO_SAMPLE* PACMAN_POWERED = NULL;
...
void shared_init(void) {
	...
	normalFont = load_font("Assets/OpenSans-Regular.ttf", fontSize);
	...
	PACMAN_POWERED = load_audio("Assets/Music/pacman_eatfruit.ogg");
}
...
void shared_destroy(void) {
	...
	al_destroy_sample(PACMAN_POWERED);
}